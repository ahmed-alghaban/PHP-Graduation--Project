...
<div class="spaceTable" style="padding-right:100px; padding-left:100px; " >
    ...
    if (isset($_POST['register']) AND check_username($_POST['username'])==FALSE) {
        ...
        $connection ->query("INSERT INTO `stores` (`store_id`, `name`, `username`, `email`, `password`, `mobile`, `city_id`, `street`, `zip_code`, `register_date`) 
												VALUES (NULL, '$name', '$username', '$email', '$password', '$mobile', '$city_id', '$street', '$zip_code', CURRENT_TIMESTAMP )");
        echo '
		<div class="success">
			  <p><strong>تمت</strong> عملية تسجيل متجرك بنجاح وجاري تحويلك إلى الصفحة الرئيسية</p>
			</div>
		';
