...
<h2>الطلبات الجديدة التي بإنتظار الموافقة</h2>
				 ...
				 <?php
						$result = $connection->query("SELECT DISTINCT `request_id` FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='new' ");
				...
				?>
					   <tr>       
							...
							<td>
								 ...
								 <?php
										$resultItems = $connection->query("SELECT * FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='new' AND request_id='".$row['request_id']."' ");
...
<h2>الطلبات الموافق عليها وتحت التنفيذ</h2>
				 ...
				 <?php
						$result = $connection->query("SELECT DISTINCT `request_id` FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='approve' ");
				...
				?>
					   <tr>       
							...
							<td>
								 ...
								 <?php
										$resultItems = $connection->query("SELECT * FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='approve' AND request_id='".$row['request_id']."' ");
...
<h2>الطلبات التي تم تسليمها</h2>
				 ...
				 <?php
						$result = $connection->query("SELECT DISTINCT `request_id` FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='deliver' ");
				...
				?>
					   <tr>       
							...
							<td>
								 ...
								 <?php
										$resultItems = $connection->query("SELECT * FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='deliver' AND request_id='".$row['request_id']."' ");
...
<h2>الطلبات المنتهية</h2>
				 ...
				 <?php
						$result = $connection->query("SELECT DISTINCT `request_id` FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='recived' ");
				...
				?>
					   <tr>       
							...
							<td>
								 ...
								 <?php
										$resultItems = $connection->query("SELECT * FROM `requestitems` WHERE client_id='".$_SESSION['ID']."' AND status='recived' AND request_id='".$row['request_id']."' ");
